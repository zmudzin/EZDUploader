    ...
    public static class ConfigurationManager
    {
        ...
        private static List<DocumentType> GetDefaultDocumentTypes()
        {
            return new List<DocumentType>
            {
                ...
                new() { Id = 7, Name = "Inny" },
                new() { Id = 8, Name = "Faktura" },
                new() { Id = 9, Name = "Zamówienie" },
                new() { Id = 10, Name = "Skarga" },
                new() { Id = 11, Name = "Nota księgowa" },
                new() { Id = 12, Name = "Odwołanie" },
                new() { Id = 13, Name = "Zawiadomienie" },
                new() { Id = 14, Name = "Umowa" },
                new() { Id = 15, Name = "Postanowienie" },
                new() { Id = 16, Name = "Zażalenie" },
                new() { Id = 17, Name = "Sprawozdanie" },
                new() { Id = 18, Name = "Rachunek" },
                new() { Id = 19, Name = "Protokół" },
                new() { Id = 20, Name = "Notatka służbowa" },
                new() { Id = 21, Name = "Wezwanie" },
                new() { Id = 22, Name = "Upoważnienie" },
                new() { Id = 23, Name = "Pełnomocnictwo" },
                new() { Id = 24, Name = "Akt notarialny" },
                new() { Id = 25, Name = "Deklaracja" },
                new() { Id = 26, Name = "Informacja" },
                new() { Id = 27, Name = "Powiadomienie" },
                new() { Id = 28, Name = "Oferta" },
                new() { Id = 29, Name = "Zgłoszenie" },
                new() { Id = 30, Name = "Petycja" },
                new() { Id = 31, Name = "Formularz" },
                new() { Id = 32, Name = "Zapytanie" },
                new() { Id = 33, Name = "Oświadczenie" },
                new() { Id = 34, Name = "Uchwała" },
                new() { Id = 35, Name = "Zgoda" },
                new() { Id = 36, Name = "Zarządzenie" }
            };
        }
